...
Router::addNewRoute('^user/wish', ['controller' => 'auth', "action" => "wish"]);
Router::addNewRoute('^user/removeWish', ['controller' => 'auth', "action" => "removeWish"]);
Router::addNewRoute('^user/shopList', ['controller' => 'auth', "action" => "shopList"]);
