...
<div class="container">
  <form action="login/auth" method="post">
    ...
    <div class="row buttons-bar justify-content-center">
      ...
      <div class="button">
        <button class="apply btn btn-success col"><a class="applyLink" href="register">Зарегистрироваться</a></button>
      </div>
      <p class="message">Пожалуйста, заполните поля правильно</p>
  </form>
</div>